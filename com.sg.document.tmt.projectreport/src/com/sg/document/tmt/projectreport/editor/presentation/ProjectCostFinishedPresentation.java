...
public class ProjectCostFinishedPresentation extends AbstractProjectDSDPresentation {
	...
	protected String getValue(DBObject editorData,ObjectId projectId, String format) {
		...
		return Util.getDecimalFormat(format).format(sum+costFinishedMonth.doubleValue());
	}
