...
$.widget("ui.carousel", {
  ...
  _init: function() {
    ...
    $.extend(this, {
      ...
      start: Math.PI/2,
      speed: 0.00, //We need a default spead so the initialization works
...
$.extend($.ui.carousel, {
  defaults: {
    animate: 0.000, //TODO: Setting animate to false also currently blocks animateByMouse
    animateByMouse: true,
    distance: 0.7,
    handle: false,
    items: '> *',
    ...
    pausable: true,
    pauseSpeed: 0.000, //If you don't want to actually stop the carousel when hovering items, set it to something small, i.e. 0.001
    radius: 200,
    tilt: -0.1
  }
});
