...
public class ChangeProjectStatusCancel extends ServiceProvider implements
		IServiceProvider {

	public ChangeProjectStatusCancel() {
	}
	...
	public Map<String, Object> run(Object parameter) {
		...
		workService.changeProjectStatus(projectOid,WorkService.VALUE_PROCESS_CANCEL);
