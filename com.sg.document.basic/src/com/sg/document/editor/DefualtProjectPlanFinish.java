...
public class DefualtProjectPlanFinish implements IDefaultValueProvider {

	public DefualtProjectPlanFinish() {
	...
	public Object getDefaultValue(ISingleObject data, String key) {
		...
		return document.get(IDBConstants.FIELD_PROJECT_PLANFINISH);
	}
