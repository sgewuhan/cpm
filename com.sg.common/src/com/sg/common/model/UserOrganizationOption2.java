...
public class UserOrganizationOption2 implements IOptionProvider {

	public UserOrganizationOption2() {
	}
	...
	public Enumerate getOption(ISingleObjectEditorInput input,ISingleObject data, String key, Object value) {
		...
		boolean hasAuthority = UserSessionContext.hasTokenAuthority(UserSessionContext.TOKEN_ORG_PROJECT_MANAGER,auth );
		if(!hasAuthority){
