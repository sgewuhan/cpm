...
public interface ILayoutSetConstants {
	 ...
	 * LayoutSet Ids
	 */
	public static final String SET_ID_CONFIG_DIALOG = "com.sg.design.layoutset.confdialog"; //$NON-NLS-1$
	public static final String SET_ID_COOLBAR = "com.sg.design.layoutset.coolbar"; //$NON-NLS-1$
	public static final String SET_ID_OVERFLOW = "com.sg.design.layoutset.coolbaroverflow"; //$NON-NLS-1$
	public static final String SET_ID_FOOTER = "com.sg.design.layoutset.footer"; //$NON-NLS-1$
	public static final String SET_ID_HEADER = "com.sg.design.layoutset.header"; //$NON-NLS-1$
	public static final String SET_ID_LOGO = "com.sg.design.layoutset.logo"; //$NON-NLS-1$
	public static final String SET_ID_MENUBAR = "com.sg.design.layoutset.menubar"; //$NON-NLS-1$
	public static final String SET_ID_PERSP = "com.sg.design.layoutset.perspective"; //$NON-NLS-1$
	public static final String SET_ID_STACKPRESENTATION = "com.sg.design.layoutset.stack"; //$NON-NLS-1$
	...
	// CoolbarInitializer
	public static final String COOLBAR_OVERFLOW_INACTIVE = "coolbar.overflow.inactive"; //$NON-NLS-1$
	public static final String COOLBAR_OVERFLOW_ACTIVE = "coolbar.overflow.active"; //$NON-NLS-1$
	...
	public static final String STACK_BORDER_BOTTOM_RIGHT = "stack.border.bottom.right";
	public static final String STACK_BORDER_TOP_RIGHT = "stack.border.top.right";
	public static final String STACK_BORDER_BOTTOM_LEFT = "stack.border.bottom.left";
	public static final String STACK_BORDER_TOP_LEFT = "stack.border.top.left";

	
	
	public static final String STACK_BORDER_BOTTOM_ACTIVE = "stack.border.bottom.active"; //$NON-NLS-1$
	public static final String STACK_BORDER_LEFT_ACTIVE = "stack.border.left.active"; //$NON-NLS-1$
	public static final String STACK_BORDER_RIGHT_AVTIVE = "stack.border.right.active"; //$NON-NLS-1$
	...
	public static final String STACK_TAB_INACTIVE_BG_ACTIVE = "stack.tab.inactive.bg.act"; //$NON-NLS-1$
	...
	public static final String STACK_TAB_INACTIVE_RIGHT_ACTIVE = "stack.tab.inactive.right.active"; //$NON-NLS-1$
	public static final String STACK_TAB_INACTIVE_SEPARATOR_ACTIVE = "stack.tab.inactive.separator.active"; //$NON-NLS-1$
	public static final String STACK_TAB_OVERFLOW_ACTIVE = "stack.tab.overflow.active"; //$NON-NLS-1$
	public static final String STACK_INACTIVE_CORNER = "stack.corner.inactive"; //$NON-NLS-1$
	public static final String STACK_TAB_INACTIVE_CORNER_ACTIVE = "stack.inactive.corner.inactive"; //$NON-NLS-1$
	...
	public static final String STACK_TABBAR_RIGHT_ACTIVE = "stack.tabbar.right.active"; //$NON-NLS-1$
	public static final String STACK_TABBAR_LEFT_ACTIVE = "stack.tabbar.left.active"; //$NON-NLS-1$
	public static final String STACK_TABBAR_RIGHT_INACTIVE = "stack.tabbar.right.inactive"; //$NON-NLS-1$
	public static final String STACK_TABBAR_LEFT_INACTIVE = "stack.tabbar.left.inactive"; //$NON-NLS-1$
	...
	public static final String STACK_TOP_STANDALONE_ACTIVE = "stack.top.standalone.active"; //$NON-NLS-1$
	public static final String STACK_TOP_STANDALONE_INACTIVE = "stack.top.standalone.inactive"; //$NON-NLS-1$

	public static final String SHELL_BG = "shell.bg";
